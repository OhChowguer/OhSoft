...
<div id="gridProdutosLoja" class="col-md-9 col-sm-9">
	...
	<div class="row">
		<div class="list">
			<c:forEach items="${produtosPorCategoria}" var="prod">
				<!-- Item #1 -->
				<div class="list-item">
					...
					<div class="col-md-4 col-sm-6">
						...
						<div class="item">
							...
							<div class="item-image">
								<a href="${url}${prod.id}&store=${loja.id}"> <img id="${prod.id}"
									src="${loja.imgLoja}"
							...
							<div class="item-details">
								...
								<h5>
									<a href="${url}${prod.id}&store=${loja.id}">${prod.nome}</a><span
										class="ico"><img src="" alt="" /></span>
								</h5>
								...
								<div class="button pull-right">
									<a onclick="addLista(${prod.id})" class="add-to-cart"  href="#" >Adicionar</a><!--  href="${pageContext.request.contextPath}/lojas/addprod/${prod.id}?qtdprod=1"-->
