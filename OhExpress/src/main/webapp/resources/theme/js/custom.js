...
$(document).ready(function(){
	  ...
	  setTimeout(function() {noty({text: '<strong>Olá! Bem vindo ao Oh!Express</strong>',layout:'topRight',type:'information',timeout:15000});}, 7000);

	  setTimeout(function() {noty({text: 'Nova Mensagem (1)',layout:'topRight',type:'alert',timeout:13000});}, 9000);
